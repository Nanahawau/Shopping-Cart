...
import {InventorySeed} from "../seeders/inventory.seed";
import {DiscountSeed} from "../seeders/discount.seed";
...
export class SeedAllStartUpData1630688494533 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const discount = await getConnection().getRepository(Discount).save(DiscountSeed);
